...
import logging
import asyncio
from typing import List, Any, Optional  # FIXED: Added Any and Optional
import aiohttp
import yt_dlp
...
def estimate_tokens(text: str, encoding: Optional[Any] = None) -> int:  # FIXED: Added Optional
...
async def download_image(url: str) -> Optional[Image.Image]:  # FIXED: Added Optional
...
async def download_file(url: str) -> Optional[bytes]:  # FIXED: Added Optional
...
def extract_youtube_id(url: str) -> Optional[str]:  # FIXED: Added Optional
    """Extract YouTube video ID"""
    patterns = [
        r'(?:youtube\.com/watch\?v=|youtu\.be/|youtube\.com/embed/|youtube\.com/v/)([a-zA-Z0-9_-]{11})',
        r'youtube\.com/shorts/([a-zA-Z0-9_-]{11})(?:\?|$)',
        r'youtube\.com/live/([a-zA-Z0-9_-]{11})',
        r'&v=([a-zA-Z0-9_-]{11})',  # Handles embedded URLs
    ]
